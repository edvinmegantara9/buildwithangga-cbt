        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    <form action="{{ route('dashboard.courses.update', $course->id) }}"
                        ...
                        <div class="flex gap-5 items-center">
                            ...
                            <div
                                class="relative w-[100px] h-[100px] rounded-full overflow-hidden">
                                <div class="relative file-preview z-10 w-full h-full">
                                    <img src="{{ Storage::url($course->cover) }}" class="thumbnail-icon w-full h-full object-cover"
                                        alt="thumbnail">
                                </div>
                                <span
                        ...
                        <div class="group/category flex flex-col gap-[10px]">
                            ...
                            <div
                                ...
                                <select id="category"
                                    ...
                                    <option value="{{ $course->category->id }}" selected hidden>{{ $course->category->name }}</option>
