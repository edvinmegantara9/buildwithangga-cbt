                ...
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    <div class="header ml-[70px] pr-[70px] w-[940px] flex items-center justify-between mt-10">
                        ...
                        <div class="relative">
                            ...
                            <div
                                ...
                                <a href="{{ route('dashboard.course.students.create', $course) }}" class="flex gap-[10px] items-center">
                                    <div class="w-5 h-5">
                                        <img src="{{ asset('images/icons/profile-2user-outline.svg') }}" alt="icon">
                                    </div>
                    ...
                    <div id="course-test" class="mx-[70px] w-[870px] mt-[30px]">
                        ...
                        <div class="flex flex-col gap-[30px] mt-2">
                            <a href="{{ route('dashboard.course.questions.create', $course) }}"
                            ...
                            <div
                                ...
                                <div class="flex items-center gap-[14px]">
                                    ...
                                    <form action="{{ route('dashboard.course-questions.destroy', $question) }}" method="POST">
                                        @csrf
                                        @method('DELETE')
                                        <button
